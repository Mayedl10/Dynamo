...
class InputHandler {
    RenderWindow* window;
public:
    InputHandler(RenderWindow* win);
    bool detectKeyPress(int32_t keycode);
    std::array<int, 5> getMouse();
};
...
// ALIASES FOR KEYCODES
    ...
    #define KEY_AC_BOOKMARKS SDLK_AC_BOOKMARKS
    ...
    #define KEY_APP1 SDLK_APP1
    #define KEY_APP2 SDLK_APP2
    #define KEY_AUDIOREWIND SDLK_AUDIOREWIND
    #define KEY_AUDIOFASTFORWARD SDLK_AUDIOFASTFORWARD
